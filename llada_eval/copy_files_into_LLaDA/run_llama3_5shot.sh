#!/usr/bin/env bash
# run_llama3_5shot.sh — Llama-3-8B-Instruct, 5-shot, 20k per difficulty.
#
...
#   OUTPUT_DIR     (default: results/llama3_5shot)
...
OUTPUT_DIR="${OUTPUT_DIR:-results/llama3_5shot}"

echo "=================================================="
echo "  Llama-3-8B-Instruct — 5-shot Sudoku Eval"
echo "=================================================="
echo "  Model          : $MODEL"
echo "  Device         : $DEVICE"
